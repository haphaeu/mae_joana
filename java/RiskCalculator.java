...
public class RiskCalculator {
	...
	void start() {
		frame = new JFrame("Risk Calculator - " + version);
		...
		JLabel tLabel = new JLabel(String.format("%30s", "Event duration [h]:"), SwingConstants.LEFT);
		tText = new JTextField(TEXT_FIELD_COLUMNS);
		textBoxes.add(tLabel);
		textBoxes.add(tText);

		JLabel vLabel = new JLabel(String.format("%30s", "Event return period:"), SwingConstants.LEFT);
		...
		JRadioButton years = new JRadioButton("years", true);
		units.add(hours);
		units.add(days);
		units.add(months);
		units.add(years);
		...
		JLabel hLabel = new JLabel(String.format("%30s", "Probability non exceedence:"), SwingConstants.LEFT);
		hText = new JTextField(TEXT_FIELD_COLUMNS);
		textBoxes.add(hLabel);
		textBoxes.add(hText);

		JLabel lLabel = new JLabel(String.format("%30s", "Operation duration [h]:"), SwingConstants.LEFT);
		lText = new JTextField(TEXT_FIELD_COLUMNS);
		textBoxes.add(lLabel);
		textBoxes.add(lText);
		
		JLabel mLabel = new JLabel(String.format("%30s", "Risk:"), SwingConstants.LEFT);
